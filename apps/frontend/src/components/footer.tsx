...
export default function Footer() {
  ...
  return (
    <footer className="bg-[var(--gray-80)] text-white">
      {/* Social Grid */}
      <div className="grid grid-cols-3 md:grid-cols-6 border-t border-b border-white/10">
        <SocialItem href="https://facebook.com" icon={<img src={facebook} alt="Facebook" className="w-10 h-10 invert brightness-0" />} />
        <SocialItem href="https://linkedin.com" icon={<img src={linkedin} alt="LinkedIn" className="w-10 h-10 invert brightness-0" />} />
        <SocialItem href="https://tiktok.com" icon={<img src={tiktok} alt="TikTok" className="w-10 h-10 invert brightness-0" />} />
        <SocialItem href="https://instagram.com" icon={<img src={instagram} alt="Instagram" className="w-10 h-10 invert brightness-0" />} />
        <SocialItem href="https://youtube.com" icon={<Youtube className="w-10 h-10" />} />
        <SocialItem href="https://twitter.com" icon={<img src={twitter} alt="X" className="w-10 h-10 invert brightness-0" />} />
      </div>

      {/* Bottom Bar */}
      <div className="container-custom py-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-neutral-400">
        <p>
          &copy; {currentYear} Proven point. Powered By Someone
        </p>
