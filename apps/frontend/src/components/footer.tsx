	...
	return (
		<footer className="bg-(--gray-80) text-white">
			...
			<div className="container-custom py-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-neutral-400">
				<p>&copy; {currentYear} Proven point. Powered By Someone</p>
...
function SocialItem({ href, icon }: { href: string; icon: React.ReactNode }) {
	return (
		<a
			...
			className="group relative flex items-center justify-center py-12 border-r border-white/10 last:border-r-0 md:last:border-r-0 nth-3:border-r-0 md:nth-3:border-r border-b md:border-b-0 nth-4:border-b-0 nth-5:border-b-0 nth-6:border-b-0 overflow-hidden"
		>
