...
function SheetContent({
  ...
  return (
    <SheetPortal>
      ...
      className={cn(
        "bg-background data-[state=open]:animate-in data-[state=closed]:animate-out fixed z-50 flex flex-col gap-4 shadow-lg transition ease-in-out data-[state=closed]:duration-700 data-[state=open]:duration-1000",
        side === "right" &&
