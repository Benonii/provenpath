    ...
    <section className="py-24 bg-white overflow-hidden">
      <div className="container mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="grid grid-cols-4 grid-rows-6 gap-4 h-[600px] md:h-[800px] w-full">
            ...
            <div className="row-start-3 row-span-2 col-start-3 col-span-2 relative">
              ...
              <img 
                src={mvv2} 
                alt="MVV 2" 
                className="w-full h-full rounded-[2rem] shadow-xl object-cover"
              />
            </div>

            {/* Third Image: next two rows, first 3 columns */}
            <div className="row-start-5 row-span-2 col-start-1 col-span-3 relative">
