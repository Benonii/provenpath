...
const services = [
  {
    ...
    description: 'Unlock your potential and build lasting habits that transform your life trajectory.',
    size: 'large'
  },
  {
    icon: Users,
  ...
  },
  {
    icon: Zap,
    title: 'Life Skills',
    description: 'Align your priorities for fulfillment and master essential life competencies.',
    size: 'normal'
  },
  {
    icon: Briefcase,
    title: 'Business Development',
    description: 'Scale your venture with proven frameworks and strategic guidance from experts.',
    size: 'large'
  },
]
...
const Services: React.FC = () => {
  ...
  return (
    <section ref={containerRef} id="services" className="relative w-full py-32 md:py-40 bg-black overflow-hidden perspective-[1000px]">
