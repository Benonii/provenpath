		...
		>
			...
			<div className="container mx-auto px-6 md:px-8 relative z-10">
				...
				<motion.div
					...
					className="relative max-w-6xl mx-auto flex flex-col sm:block sm:aspect-video md:aspect-21/9 overflow-hidden group cursor-pointer bg-zinc-900/30 backdrop-blur-md border border-white/10 hover:border-accent transition-colors duration-500"
				>
