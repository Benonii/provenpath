...
const useStore = create<Store>()((set) => ({
	...
	setSocialSignInPending: (pending: boolean) =>
		set({ socialSignInPending: pending }),
	signupPending: false,
	setSignupPending: (pending: boolean) => set({ signupPending: pending }),
	forgotPasswordPending: false,
	setForgotPasswordPending: (pending: boolean) =>
		set({ forgotPasswordPending: pending }),
	forgotPasswordEmailSent: false,
	setForgotPasswordEmailSent: (sent: boolean) =>
		set({ forgotPasswordEmailSent: sent }),
	resetPasswordPending: false,
	setResetPasswordPending: (pending: boolean) =>
		set({ resetPasswordPending: pending }),
	passwordReset: false,
